...
|15|Rule build not found in Makefile!|<i class="fa fa-check"></i>|No folder for the output tests found!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|

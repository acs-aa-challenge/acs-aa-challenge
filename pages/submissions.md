...
|26|Rule build not found in Makefile!<br>Rule run-p1 not found in Makefile!<br>Rule run-p2 not found in Makefile!<br>Rule run-best not found in Makefile!|<i class="fa fa-check"></i>|No folder for the input tests found!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|

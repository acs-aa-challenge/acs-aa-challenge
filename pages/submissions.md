...
|97|Rule run-best not found in Makefile!|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|132|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|201|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|141|No Makefile found!|No README file found!|No folder for the input tests found!|PDF document not found|<i class="fa fa-bug"></i>|
|233|Rule run-p1 not found in Makefile!<br>Rule run-p2 not found in Makefile!<br>Rule run-best not found in Makefile!|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|221|Rule run-best not found in Makefile!|<i class="fa fa-check"></i>|Only 7 input tests generated!<br>Test test2.in likely has a duplicate!<br>Test test6.in likely has a duplicate!<br>Unique tests: 5 / 7!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|4|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|205|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|213|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|238|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|257|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|139|No Makefile found!|No README file found!|Found 20 tests.<br>Test test11.in likely has a duplicate!<br>Test test12.in likely has a duplicate!<br>Test test13.in likely has a duplicate!<br>Test test14.in likely has a duplicate!<br>Test test15.in likely has a duplicate!<br>Test test16.in likely has a duplicate!<br>Test test17.in likely has a duplicate!<br>Test test18.in likely has a duplicate!<br>Test test19.in likely has a duplicate!<br>Test test20.in likely has a duplicate!<br>Test test4.in likely has a duplicate!<br>Test test5.in likely has a duplicate!<br>Test test6.in likely has a duplicate!<br>Test test7.in likely has a duplicate!<br>Test test8.in likely has a duplicate!<br>Test test9.in likely has a duplicate!<br>Unique tests: 4 / 20!|PDF document not found|<i class="fa fa-bug"></i>|
...
|36|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|No folder for the output tests found!|PDF document not found|<i class="fa fa-bug"></i>|
|113|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|272|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|2|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|27|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|77|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|265|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|189|Rule build not found in Makefile!|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|126|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|85|No Makefile found!|No README file found!|No folder for the input tests found!|PDF document not found|<i class="fa fa-bug"></i>|
...
|249|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|Found 100 tests.<br>Number of input tests doesn't match number of output tests!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
|234|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|120|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|116|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|252|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|109|No Makefile found!|<i class="fa fa-check"></i>|Found 20 tests.<br>Number of input tests doesn't match number of output tests!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
|253|No Makefile found!|No README file found!|No folder for the input tests found!|PDF document not found|<i class="fa fa-bug"></i>|
|212|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|Found 60 tests.<br>Number of input tests doesn't match number of output tests!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
|111|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|9|Rule build not found in Makefile!<br>Rule run-p1 not found in Makefile!<br>Rule run-p2 not found in Makefile!<br>Rule run-best not found in Makefile!|<i class="fa fa-check"></i>|Found 34 tests.<br>Test test13.in likely has a duplicate!<br>Test test17.in likely has a duplicate!<br>Test test19.in likely has a duplicate!<br>Test test8.in likely has a duplicate!<br>Unique tests: 30 / 34!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|1|No Makefile found!|<i class="fa fa-check"></i>|No folder for the output tests found!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
|177|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|184|Rule build not found in Makefile!|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|72|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|No folder for the input tests found!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|20|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|45|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|198|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|98|Rule build not found in Makefile!|<i class="fa fa-check"></i>|Found 23 tests.<br>Test test2.in likely has a duplicate!<br>Test test3.in likely has a duplicate!<br>Test test4.in likely has a duplicate!<br>Test test5.in likely has a duplicate!<br>Unique tests: 19 / 23!<br>Number of input tests doesn't match number of output tests!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
...
|160|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|51|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|No folder for the input tests found!|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
|33|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|122|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|55|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|170|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|181|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|74|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|26|Rule build not found in Makefile!<br>Rule run-p1 not found in Makefile!<br>Rule run-p2 not found in Makefile!<br>Rule run-best not found in Makefile!|<i class="fa fa-check"></i>|No folder for the input tests found!|PDF document not found|<i class="fa fa-bug"></i>|
|91|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|150|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|236|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|264|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|6|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|PDF document not found|<i class="fa fa-bug"></i>|
...
|207|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
...
|108|Rule run-best not found in Makefile!|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-bug"></i>|
|261|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
|80|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|<i class="fa fa-check"></i>|
